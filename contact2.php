<?php
// contact.php - ENVOI D'EMAIL AVEC GMAIL

// ============================================
// CONFIGURATION GMAIL - À MODIFIER
// ============================================
// Remplace ces valeurs par les tiennes :
$gmail_user = "ton-email@gmail.com";           // Ton adresse Gmail
$gmail_password = "ton-mot-de-passe-app";      // Mot de passe d'application (voir instructions)
$destinataire = "contact@pacocean.ma";         // Email qui recevra les messages
...
if (isset($_POST['envoyer'])) {
    ...
    if (empty($nom) || empty($email) || empty($message)) {
        ...
        // Préparer le message
        $sujet_email = "Nouveau message - " . $sujet;
        
        $corps_message = "
Nouveau message depuis le site PACOCEAN :
...
Envoyé le " . date('d/m/Y à H:i:s');
        ...
        // Configuration des headers pour Gmail
        ...
        ini_set("sendmail_from", $gmail_user);
        ...
        if (mail($destinataire, $sujet_email, $corps_message, $headers)) {
            ...
            $erreur = "Erreur lors de l'envoi. Vérifiez votre configuration Gmail.";
        }
    }
}
